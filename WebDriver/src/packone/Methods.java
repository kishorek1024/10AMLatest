...
public class Methods {
	...
	public void elementPresent(String loc, boolean exp){
		...
		if(a==exp)
			System.out.println("Pass" + "-" + "Actual is " + a + "-" + " Expected is " + exp);
		else
			System.out.println("Fail" + "-" + "Actual is " + a + "-" + " Expected is " + exp);
	}
	public void elementsCount(String loc, int exp){
		...
		if(elements.size()==exp)
			System.out.println("Pass " + "-" + "Actual is " + elements.size() + "-" + " Expected is " + exp );
		else
			System.out.println("Fail " + "-" + "Actual is " + elements.size() + "-" + " Expected is " + exp );
